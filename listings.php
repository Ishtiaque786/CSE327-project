...
<html lang="en">
  <head>
    ...
    <title><?php echo $site_titlex; ?> - Listings</title>
  </head>
  <body>
            ...
            <div class="featured-box">
              ...
              <div class="feature-content">
                ...
                <div class="listing-bottom">
                  <h3 style="font-size:18px;" class="price float-left"><?php echo $currency_before; ?> <?php echo number_format($row['price']); ?> <?php echo $currency; ?></h3>
