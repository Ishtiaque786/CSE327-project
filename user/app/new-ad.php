...
$datepost = date('M d, Y');
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_ads (ad_id, author, title, category, city, ad_condition, price, phone, short_desc, fixed, brand, description, date_posted) VALUES (:adid, :author, :title, :category, :city, :adcond, :price, :phone, :shortdesc, :fixed, :brand, :description, :datepost)");
