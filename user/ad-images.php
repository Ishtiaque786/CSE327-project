...
<html lang="en">
  <head>
    ...
    <title><?php echo $site_titlex; ?> - Manage Ad Images</title>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="inner-box">
                  ...
                  <div class="dashboard-wrapper">
                    <p>Browse image files to upload for the Ad <b><?php echo $ad_title; ?></b><br>All images must have a dimension of <strong>1:1 ratio</strong><span class="required">*</span></p>
					...
					<hr>
					<a href="myads"><button class="btn btn-common" type="submit">Done</button></a>
                  </div>
                </div>
              </div>
            </div>
