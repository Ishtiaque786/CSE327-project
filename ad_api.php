...
<html lang="en">
  <head>
    ...
    user-scalable=0">
    <title><?php echo $site_titlex; ?> - <?php echo $title; ?></title>
    <?php
          ...
          <div class="col-lg-8 col-md-12 col-xs-12">
            <div class="ads-details-wrapper">
              <div id="owl-demo" class="owl-carousel owl-theme">
                <?php
                  ...
                  <span class="price">'.$currency_before.' '.number_format($price).' '.$currency.'</span>
                  </div>
            ...
            <div class="details-box">
              <div class="ads-details-info">
                ...
                <h2><?php echo $currency_before; ?> <?php echo $price; ?><?php echo $currency; ?></h2>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12">
            <aside class="details-sidebar">
              ...
              <div class="short-desc-wrapper">
                <h4 class="widget-title">Quick overview</h4>
                <p class="mb-4"><?php echo $short_des; ?></p>
              </div>
                ...
                <div class="agent-inner">
                  <div class="agent-title">
                    ...
                    <p>Phone No.: +880<?php echo $phone; ?></p>
                    </div>
                  </div>
                  <?php
