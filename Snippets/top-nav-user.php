            ...
            <div class="col-lg-7 col-md-5 col-xs-12">
               <ul class="list-inline">
                  ...
                  <?php
                     if ($logged == "1") {
                        ?>
                  <li><a class="not-on-desktop" style="position: absolute;top: 0;right: 80px;" href="./" class="header-top-button"><i class="lni-user"></i> My Account</a>
   ...
   <nav class="navbar navbar-expand-lg bg-catbar fixed-top scrolling-navbar">
      <div class="container">
         ...
         <div class="collapse navbar-collapse" id="main-navbar">
            <ul class="navbar-nav mr-auto w-100 justify-content-center">
               ...
               <li class="nav-item">
                  <a class="nav-link" id="show" href="#"><i class="lni-search"></i>
                  Search
                  </a>
               </li>
               <li class="nav-item">
                  <a class="nav-link" id="hide" href="#"><i class="lni-search"></i>
                  Search
                  </a>
               </li>
            </ul> 
      ...
      <ul class="mobile-menu">
         ...
         <?php
                     if ($logged == "1") {
                        ?>
                  <li class="nav-item"><a  class="only-on-smd nav-link" href="./" class="header-top-button"></i> My Account</a>
                  <li class="nav-item"><a class="only-on-smd nav-link" href="../logout" class="header-top-button"> Log Out</a></li>
                  <?php
                     }else{
