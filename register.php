...
<html lang="en">
  <head>
    ...
    <title><?php echo $site_titlex; ?> - Register</title>
  </head>
  <body>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-5 col-md-12 col-xs-12">
            <div class="register-form login-area">
              ...
              <form name="frm1" class="login-form" action="app/register.php" method="POST" autocomplete="off" onsubmit="return checkall();">
                ...
                <div class="form-group">
                  <div class="input-icon">
                    <i class="lni-user"></i>
                    <input type="text" id="UserName" class="form-control" name="user_name" required placeholder="Full Name" onkeyup="checkname();">
                  </div>
                </div>
                <div class="form-group" style="display: flex;">
                    <input class="form-control input-md" placeholder="+880" style="width: 55px;pointer-events: none; "><input maxlength="10" style="width: -webkit-fill-available;" class="form-control input-md" type="tel" placeholder="123-456-6789" id="phone_no" name="phone_no">
                </div>
                <div class="form-group">
                  <div class="input-icon">
              ...
              <p style="text-align: center; padding:0 10px 20px">Already a member? <a href="./login.php">Login Now</a></p>
            </div>
          </div>
        </div>
      </div>
